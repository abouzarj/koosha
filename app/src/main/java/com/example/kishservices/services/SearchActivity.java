...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = findViewById(R.id.search_try_again_button);
    ...
    private void getData(String query, Integer pageNumber){
        ...
        String token = "JWT " + sharedPreferences.getString("access","");
        Call<ServicesResponse> servicesResponseCall = apiInterface.SearchServices(token,query.trim(),pageNumber,null);
